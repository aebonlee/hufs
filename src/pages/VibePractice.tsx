...
const CATEGORIES: Category[] = [
  ...
  { id: 'streamlit', label: '스트림릿', icon: 'fa-chart-line', desc: 'Python 행정 데이터 앱' },
  { id: 'data', label: '데이터 분석', icon: 'fa-chart-bar', desc: 'Python 행정 데이터 분석 & 시각화' },
  { id: 'ai', label: 'AI 앱', icon: 'fa-robot', desc: 'Claude API 연동' },
];
...
const PROJECTS: Project[] = [
  /* ── 웹 개발 ── */
  {
    id: 1, categoryId: 'web',
    title: '행정 업무 To-Do 앱',
    description: 'React + TypeScript로 행정 업무 할 일 관리 앱을 만듭니다. 업무 입력, 처리 체크, 삭제, 상태 필터링과 localStorage 데이터 유지를 구현합니다.',
    difficulty: '초급', duration: '30분',
    techStack: ['React', 'TypeScript', 'CSS'],
    steps: ['Claude Code로 새 React + Vite 프로젝트 생성', 'TaskItem 컴포넌트 설계', 'useState로 상태 관리', '추가/삭제/완료토글 구현', 'localStorage 연동', 'CSS 스타일링 및 반응형'],
...
- 모바일 반응형 디자인`,
  },
  {
    id: 2, categoryId: 'web',
    title: '학과 소개 사이트',
    description: '학과(부서) 소개 SPA를 제작합니다. Hero, 학과 소개, 교육과정, 교수진, 문의 섹션과 스크롤 애니메이션을 적용합니다.',
    difficulty: '중급', duration: '45분',
    techStack: ['React', 'TypeScript', 'CSS', 'AOS'],
    steps: ['섹션별 컴포넌트 설계', 'Navbar 스크롤 이벤트 처리', 'CSS Grid/Flexbox 반응형 레이아웃', 'AOS 라이브러리 스크롤 애니메이션', '문의 폼 UI', 'GitHub Pages 배포'],
...
- 다크 네이비 (#1B2A4A) + 골드 (#D4760A) 색상 테마`,
  },
  {
    id: 3, categoryId: 'web',
    title: '학생 공지·문의 게시판',
    description: 'Supabase 백엔드로 회원가입, 로그인, 공지 게시글 CRUD, 댓글 문의 기능이 있는 학생 게시판을 구현합니다.',
    difficulty: '고급', duration: '60분',
    techStack: ['React', 'TypeScript', 'Supabase', 'PostgreSQL'],
    steps: ['Supabase 프로젝트 생성 및 테이블 설계', 'Auth 회원가입/로그인 구현', 'RLS 정책 설정', '공지 게시글 CRUD 기능', '댓글 문의 기능 추가', 'React Router 라우팅'],
...
- 모바일 반응형`,
  ...
  {
    id: 4, categoryId: 'web',
    title: '교환학생 모집 랜딩 페이지',
    description: '교환학생·국제교류 프로그램 모집용 원페이지 랜딩 페이지를 만듭니다. 히어로 배너, 프로그램 소개, 지원 절차, 지원 CTA, FAQ 아코디언을 포함합니다.',
    difficulty: '중급', duration: '40분',
    techStack: ['React', 'TypeScript', 'CSS'],
    steps: ['섹션 구조 설계 (Hero, Programs, Process, FAQ, CTA)', '히어로 배너 (그라디언트 배경 + CTA 버튼)', '프로그램 카드 그리드 (아이콘 + 설명)', '지원 절차 3단계 비교 카드', 'FAQ 아코디언 (클릭 시 펼침)', 'Smooth Scroll 네비게이션'],
    prompt: `너는 React 프론트엔드 전문 개발자야.
...
- AOS로 스크롤 애니메이션`,
  },
  {
    ...
    title: '환율 조회 앱',
    description: '환율 API를 연동하여 통화별 현재 환율, 금액 변환, 환율 추이를 표시하는 반응형 앱입니다. 외국인 유학생·교환학생 안내에 활용합니다.',
    difficulty: '초급', duration: '35분',
    techStack: ['React', 'TypeScript', 'CSS', 'API'],
    steps: ['환율 API 키 발급 (exchangerate-api 등)', '기준/대상 통화 선택 UI 구현', '금액 입력 → 실시간 변환 카드', '주요 통화 환율 비교 카드', '환율 상태에 따른 색상 동적 변경', '최근 조회 통화 localStorage 저장'],
    prompt: `너는 React + TypeScript 전문 프론트엔드 개발자야.
...
- 로딩 스피너 및 에러 핸들링`,
  },
  {
    ...
    title: '행정 통계 대시보드',
    description: 'Chart.js로 수강신청, 재학생, 민원 처리 통계를 시각화하는 행정 대시보드입니다. 사이드바 네비게이션과 다크모드를 포함합니다.',
    difficulty: '고급', duration: '60분',
    techStack: ['React', 'TypeScript', 'Chart.js', 'CSS'],
    steps: ['사이드바 네비게이션 구현', 'KPI 카드 4개 (재학생, 수강신청, 민원, 방문)', '월별 추이 라인 차트 (Chart.js)', '학과별 도넛 차트', '최근 민원 처리 테이블', '다크/라이트 모드 토글'],
    prompt: `너는 React + TypeScript 전문 프론트엔드 개발자야.
...
- 샘플 데이터 JSON으로 포함`,
  ...
  /* ── 스트림릿 ── */
  {
    ...
    title: '수강신청 현황 대시보드',
    description: 'CSV를 업로드하여 학과별/과목별 수강신청 현황을 시각화하는 Streamlit 대시보드입니다.',
    difficulty: '중급', duration: '30분',
    techStack: ['Streamlit', 'pandas', 'plotly'],
    steps: ['Streamlit 프로젝트 설정 및 requirements.txt', 'CSV 업로드 위젯 구현', '사이드바 필터 (학기, 학과)', 'KPI 카드 3개 (st.metric)', '과목별 신청 추이 라인 차트', '학과별 비교 막대 차트'],
...
- 데이터가 없을 때 샘플 데이터 자동 생성`,
  },
  {
    ...
    title: 'CSV 데이터 탐색기',
    description: '어떤 행정 CSV 파일이든 업로드하면 자동으로 데이터 요약, 통계, 시각화를 제공하는 범용 도구입니다.',
...
- 모든 한글 데이터 정상 표시`,
  },
  {
    ...
    title: '담당자 소개 앱',
    description: 'Streamlit으로 만드는 첫 번째 앱입니다. 이름, 사진, 담당 업무, 스킬 바, 연락처를 표시하는 인터랙티브 행정 담당자 소개 페이지입니다.',
...
- requirements.txt 포함`,
  },
  {
    ...
    title: '행정 업무 일지 관리 앱',
    description: '일일 행정 업무 일지를 작성하고 저장하는 Streamlit 앱입니다. 날짜별 조회, 업무 분류, JSON 저장 기능을 포함합니다.',
    difficulty: '중급', duration: '30분',
    techStack: ['Streamlit', 'pandas', 'json'],
    steps: ['업무 일지 입력 폼 설계', '날짜/분류/내용 입력 위젯', 'JSON 파일로 저장/불러오기', '날짜별 필터링 및 조회', '분류별 통계 차트', '일지 삭제 기능'],
    prompt: `너는 Python Streamlit 전문 개발자야.
...
- 깔끔한 카드형 일지 표시`,
  },
  {
    ...
    title: '행사 사진 갤러리 뷰어',
    description: '세미나·행사 사진을 업로드하면 갤러리 형태로 표시하고, 필터(밝기/대비/흑백)를 적용할 수 있는 Streamlit 앱입니다.',
...
- requirements.txt 포함`,
  },
  {
    ...
    title: '부서 예산 관리 앱',
    description: '부서 예산의 수입/지출을 기록하고 월별 통계와 항목별 지출 차트를 보여주는 Streamlit 예산 관리 앱입니다.',
    difficulty: '중급', duration: '35분',
    techStack: ['Streamlit', 'pandas', 'plotly', 'json'],
    steps: ['수입/지출 입력 폼', '항목 분류 (인건비, 행사비, 비품 등)', '월별 수입/지출 막대 차트', '항목별 지출 도넛 차트', '일별 잔액 추이 라인 차트', 'JSON 데이터 저장 및 CSV 내보내기'],
    prompt: `너는 Python Streamlit 전문 개발자야.
...
- requirements.txt 포함`,
  ...
  /* ── 데이터 분석 ── */
  {
    ...
    title: '민원 데이터 분석기',
    description: '학생 민원·문의 이력 Excel 데이터를 분석하여 유형별 빈도, 월별 추이, 부서별 분포, 처리시간 통계를 시각화합니다.',
    difficulty: '중급', duration: '35분',
    techStack: ['Streamlit', 'pandas', 'plotly', 'openpyxl'],
    steps: ['Excel/CSV 업로드 위젯', '민원 유형별 도넛 차트', '월별 민원 추이 라인 차트', '부서별 분포 막대 차트', '평균 처리시간 통계', '민원 사유 Top 5'],
...
- st.tabs로 분석 항목별 탭 구성`,
  },
  {
    ...
    title: 'Excel 자동 보고서',
    description: 'Python으로 행정 Excel 데이터를 읽어 자동으로 요약 통계, 차트, 서식이 적용된 보고서를 생성합니다.',
    difficulty: '중급', duration: '30분',
    techStack: ['Streamlit', 'pandas', 'openpyxl', 'xlsxwriter'],
    steps: ['Excel 업로드 및 시트 선택', '데이터 요약 통계 자동 계산', '차트 자동 생성 (신청 추이, 부서별 비교)', '서식 적용된 Excel 보고서 생성', '보고서 다운로드 버튼', '멀티 시트 지원'],
...
- requirements.txt 포함`,
  },
  {
    ...
    title: '강의평가 설문 분석기',
    description: '강의평가·만족도 설문 CSV 데이터를 업로드하여 응답 분포, 교차 분석, 워드 클라우드를 자동 생성합니다.',
    difficulty: '중급', duration: '30분',
    techStack: ['Streamlit', 'pandas', 'plotly', 'wordcloud'],
    steps: ['CSV 업로드 및 컬럼 자동 분류', '단일 선택 문항 → 막대/파이 차트', '복수 선택 문항 → 수평 막대 차트', '리커트 척도 → 평균 점수 비교', '주관식 → 워드 클라우드', '교차 분석 (학과별 × 만족도)'],
...
- requirements.txt 포함`,
  },
  {
    ...
    title: '장학금 지급 데이터 분석',
    description: '장학금 지급 CSV를 업로드하면 월별 추이, 장학금 종류별 비율, 전년 대비 증감, 학과별 분포를 자동 분석합니다.',
    difficulty: '초급', duration: '25분',
    techStack: ['Streamlit', 'pandas', 'plotly'],
    steps: ['CSV 업로드 및 데이터 검증', '월별 지급액 추이 라인 차트', '장학금 종류별 비율 도넛 차트', '전년 대비 증감 계산', 'KPI 카드 (총지급액, 평균, 최고월)', '필터링된 데이터 다운로드'],
    prompt: `너는 Python 데이터 분석 + Streamlit 전문 개발자야.
...
- requirements.txt 포함`,
  },
  {
    ...
    title: '재학생 현황 대시보드',
    description: '재학생 학적 데이터를 분석하여 학과별 인원, 학년 분포, 성별 비율, 휴학/복학 추이를 시각화합니다.',
    difficulty: '중급', duration: '35분',
    techStack: ['Streamlit', 'pandas', 'plotly'],
    steps: ['Excel/CSV 업로드 위젯', '학과별 인원 현황 막대 차트', '학년 분포 히스토그램', '성별/학년별 교차 분석', '월별 휴학/복학 추이', '핵심 학적 지표 KPI 카드'],
    prompt: `너는 Python 데이터 분석 + Streamlit 전문 개발자야.
...
- requirements.txt 포함`,
  },
  {
    ...
    title: '포털 접속 로그 분석기',
    description: '대학 포털·홈페이지 접속 로그를 분석하여 시간대별 트래픽, 인기 페이지, 브라우저 분포, 에러율을 시각화합니다.',
...
- requirements.txt 포함`,
  ...
  /* ── AI 앱 ── */
  {
    id: 12, categoryId: 'ai',
    title: '학사 안내 챗봇 (풀스택)',
    description: 'Claude API와 Supabase를 연동하여 대화 이력이 저장되는 학사 안내 AI 챗봇 웹앱을 React로 만듭니다.',
    difficulty: '고급', duration: '60분',
...
- 모바일 반응형`,
  },
  {
    ...
    description: 'Claude API를 연동한 Streamlit 채팅 앱입니다. 대화 이력을 유지하고, 대학 행정 도우미 역할을 수행합니다.',
    difficulty: '중급', duration: '30분',
...
- requirements.txt 포함`,
  },
  {
    id: 14, categoryId: 'ai',
    title: 'AI 보고서 생성기',
    description: '행정 CSV 데이터를 업로드하면 Claude API가 자동으로 분석 보고서를 작성합니다.',
...
- requirements.txt 포함`,
  },
  {
    id: 15, categoryId: 'ai',
    title: 'AI 공문 요약기',
    description: '긴 공문이나 안내문을 붙여넣으면 Claude API가 핵심 요약, 키워드 추출, 3줄 요약을 생성합니다.',
...
- requirements.txt 포함`,
  },
  {
    id: 23, categoryId: 'ai',
    title: 'AI 번역기',
    description: '한국어↔영어↔일본어↔중국어 다국어 번역기입니다. Claude API를 활용하여 유학생 안내문을 자연스럽게 번역하고 문체를 선택할 수 있습니다.',
    difficulty: '초급', duration: '20분',
    techStack: ['Streamlit', 'anthropic'],
    steps: ['언어 선택 UI (출발/도착 언어)', '텍스트 입력 영역', 'Claude API 번역 호출', '문체 옵션 (격식/비격식/공문)', '번역 결과 표시 및 복사', '번역 이력 표시'],
    prompt: `너는 Python + Streamlit + Claude API 전문 개발자야.
...
- requirements.txt 포함`,
  },
  {
    id: 24, categoryId: 'ai',
    title: 'AI 코드 리뷰어',
    description: '코드를 붙여넣으면 Claude API가 버그, 보안 취약점, 개선 사항을 분석하고 리팩토링 제안을 합니다. 업무 자동화 스크립트 점검에 활용합니다.',
...
const VibePractice = (): ReactElement => {
  ...
  return (
    <>
      <SEOHead title="바이브코딩 실습 | 한국외국어대학교 대학 행정 Vibe Coding" description="대학 행정 실무를 위한 분야별 실전 프로젝트 — 웹 개발, 스트림릿, 데이터 분석, Claude AI 앱" />

      <section className="page-header-ed">
        <div className="container">
          <div className="eyebrow">Vibe Coding Lab</div>
          <h2>바이브코딩 실습</h2>
          <p>대학 행정 분야별 실전 프로젝트를 선택하고, Claude Code로 직접 만들어봅니다</p>
        </div>
      </section>
