...
const sections = [
  { id: 'part1', label: '1교시. Claude 이해 & 행정 프롬프트' },
  { id: 'part2', label: '2교시. 개발 환경 & 웹페이지 만들기' },
];
...
const LectureBasic = (): ReactElement => {
  ...
  return (
    <>
      <SEOHead title="1부 강의안 — Claude 바이브코딩 입문" description="대학 행정 실무를 위한 바이브 코딩 기초 1부: Claude 이해, 행정 프롬프트, 개발 환경, 첫 웹페이지" />

      <section className="page-header-ed">
        <div className="container">
          <div className="eyebrow">Session 1 Lecture</div>
          <h2>1부 강의안 — Claude 바이브코딩 입문</h2>
          <p>1부 · Claude 입문 &amp; 행정 자동화</p>
        </div>
      </section>
          ...
          <div className="lecture-main">
            <div className="lecture-page" style={{ padding: 0, maxWidth: 'none' }}>
              ...
              <div id="part1" className="lecture-section">
                <h3>1교시. 바이브코딩·Claude 이해 &amp; 행정 프롬프트 작성법 (10:00~11:00)</h3>
...
(명단 데이터 붙여넣기)"`}</div>
              ...
              <div id="part2" className="lecture-section">
                <h3>2교시. 개발 환경 준비 &amp; 행정 안내 웹페이지 만들기 (11:00~12:00)</h3>
                <div className="lecture-content">
                  <h4>1. 무엇을 준비하나요?</h4>
                  <ul>
...
# 첫 로그인은 안내에 따라 브라우저에서 인증`}</div>
                  <div className="example-box">
                    터미널이 낯설다면 <strong>Claude.ai 웹</strong>만으로도 1부 실습을
...
색상은 남색(네이비) 계열로 차분하게, 제목은 크게."`}</div>
                  ...
                  <div className="tip-box">
                    <strong>다음 시간 예고</strong>: 2부에서는 이 페이지를 실제 “도구”로
