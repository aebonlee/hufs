...
const sections = [
  ...
  { id: 'claude-code', label: 'Claude Code 설치' },
...
const LectureSetup = (): ReactElement => {
  ...
  return (
    <>
      <SEOHead title="실습 환경 설정" description="바이브코딩 교육 실습을 위한 개발 환경 설정 가이드 — VS Code, Git, Node.js, GitHub, Claude Code" />
              ...
              <div id="github" className="lecture-section">
                ...
                <div className="lecture-content">
                  ...
                  <svg viewBox="0 0 720 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="setup-diagram">
                    ...
                    <text x="90" y="110" textAnchor="middle" fill="#A3B1C2" fontSize="10" fontFamily="system-ui">Claude Code로</text>
...
# → https://사용자명.github.io/리포이름/ 에서 확인`}</div>
              ...
              {/* ═══ Claude Code 설치 ═══ */}
              <div id="claude-code" className="lecture-section">
                <h3>5. Claude Code 설치</h3>
                <div className="lecture-content">
                  <h4>Claude Code란?</h4>
                  <p>
                    Claude Code는 Anthropic이 만든 터미널 기반 AI 코딩 에이전트입니다.
                    자연어로 요청하면 파일을 직접 생성·수정하고, 코드를 작성하며, 배포까지 도와줍니다.
                    VS Code 터미널에서 <code>claude</code> 명령으로 실행하며, 바이브코딩의 핵심 도구입니다.
                  </p>

                  {/* Claude Code = 터미널 + AI 에이전트 다이어그램 */}
                  <svg viewBox="0 0 720 190" fill="none" xmlns="http://www.w3.org/2000/svg" className="setup-diagram">
                    ...
                    <text x="130" y="74" textAnchor="middle" fill="#007ACC" fontSize="28" fontFamily="monospace">&gt;_</text>
                    <text x="130" y="98" textAnchor="middle" fill="#007ACC" fontSize="14" fontWeight="bold" fontFamily="system-ui">터미널</text>
                    <text x="130" y="118" textAnchor="middle" fill="#A3B1C2" fontSize="10" fontFamily="system-ui">claude 명령 실행</text>
                    <text x="130" y="132" textAnchor="middle" fill="#A3B1C2" fontSize="10" fontFamily="system-ui">프로젝트 폴더에서</text>
                    {/* + 기호 */}
                    ...
                    <text x="400" y="74" textAnchor="middle" fill="#A371F7" fontSize="28" fontFamily="system-ui">&#129302;</text>
                    <text x="400" y="98" textAnchor="middle" fill="#A371F7" fontSize="14" fontWeight="bold" fontFamily="system-ui">Claude AI</text>
                    <text x="400" y="118" textAnchor="middle" fill="#A3B1C2" fontSize="10" fontFamily="system-ui">자연어 이해</text>
                    <text x="400" y="132" textAnchor="middle" fill="#A3B1C2" fontSize="10" fontFamily="system-ui">파일 생성 & 수정</text>
                    {/* = 기호 */}
                    ...
                    <text x="640" y="90" textAnchor="middle" fill="#3FB950" fontSize="14" fontWeight="bold" fontFamily="system-ui">Claude Code</text>
                    <text x="640" y="110" textAnchor="middle" fill="#E6EDF3" fontSize="10" fontFamily="system-ui">AI 코딩</text>
                    <text x="640" y="124" textAnchor="middle" fill="#E6EDF3" fontSize="10" fontFamily="system-ui">에이전트</text>
                  ...
                  <div className="tip-box">
                    ...
                    Claude Code는 npm으로 전역 설치합니다. 먼저 Node.js(3단계)가 설치되어 있어야 합니다.<br />
                    <a href="https://docs.claude.com/claude-code" target="_blank" rel="noopener noreferrer">
                      https://docs.claude.com/claude-code
                    </a>
                  </div>

                  <div className="prompt-example">{`# Claude Code 전역 설치 (npm)
...
claude --version`}</div>
                  ...
                  <div className="example-box">
                    <strong>설치 & 로그인 순서</strong><br /><br />
                    1. 터미널(VS Code 내장 터미널 또는 Git Bash)을 엽니다<br />
                    2. <code>npm install -g @anthropic-ai/claude-code</code> 실행<br />
                    3. 프로젝트 폴더에서 <code>claude</code> 명령으로 실행<br />
                    4. 첫 실행 시 브라우저가 열리며 Claude 계정으로 로그인(인증)<br />
                    5. 인증이 완료되면 터미널로 돌아와 대화 시작
                  </div>

                  <h4>Claude Code 사용 기초</h4>
                  <div className="example-box">
                    <strong>기본 사용 흐름</strong><br /><br />
                    1. 작업할 프로젝트 폴더로 이동: <code>cd my-test-app</code><br />
                    2. 세션 시작: <code>claude</code><br />
                    3. 자연어로 요청 — 예: &quot;행정 안내 웹페이지를 만들어줘&quot;<br />
                    4. Claude Code가 파일을 생성·수정하면 변경 내용을 확인하고 승인<br />
                    5. 도움말 보기: <code>/help</code><br />
                    6. 세션 종료: <code>/exit</code> 또는 <code>Ctrl+C</code> 두 번
                  </div>

                  <h4>자연어로 일하기</h4>
                  <div className="example-box">
                    <strong>요청 예시 (자연어 그대로 입력)</strong><br /><br />
                    - &quot;행정 안내 웹페이지를 만들어줘&quot;<br />
                    - &quot;공지사항 목록을 추가하고 카드 형태로 보여줘&quot;<br />
                    - &quot;방금 만든 페이지를 GitHub Pages로 배포해줘&quot;<br />
                    - &quot;에러가 나는데 원인을 찾아서 고쳐줘&quot;<br /><br />
                    명령어 대신 평소 말하듯이 요청하면 Claude Code가 알아서 파일을 만들고 고칩니다.
                  </div>

                  <div className="tip-box">
                    <strong>참고</strong>: Claude Code는 VS Code 터미널 안에서 함께 사용합니다.
                    코드 편집은 VS Code로, 파일 생성·수정·배포 같은 작업은 자연어로 Claude Code에게 맡기면 됩니다.
                  </div>
                </div>
              </div>
              ...
              <div id="verify" className="lecture-section">
                ...
                <div className="lecture-content">
                  ...
                  <svg viewBox="0 0 720 260" fill="none" xmlns="http://www.w3.org/2000/svg" className="setup-diagram">
                    ...
                    <text x="250" y="88" textAnchor="middle" fill="#3FB950" fontSize="11" fontWeight="bold" fontFamily="system-ui">Claude Code</text>
...
claude --version`}</div>
                  ...
                  <div className="example-box">
                    ...
                    &#9745; GitHub 계정 생성됨<br />
                    &#9745; Claude Code 설치됨 (claude --version 출력 확인)
                  </div>
