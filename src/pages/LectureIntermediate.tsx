          ...
          <aside className="lecture-sidebar">
            ...
            <div className="ls-guide">
              ...
              <ul className="ls-guide-list">
                <li>행정 업무를 도구로 기획합니다</li>
                <li>Claude로 동작하는 웹앱을 만듭니다</li>
                <li>데이터를 연동해 반복 업무를 자동화합니다</li>
                <li>GitHub Pages로 배포해 공유합니다</li>
              </ul>
            </div>
            ...
            <div className="lecture-page" style={{ padding: 0, maxWidth: 'none' }}>
              ...
              <div id="part1" className="lecture-section">
                ...
                <div className="lecture-content">
                  <h4>1. “자동화 거리” 찾기</h4>
                  <p>
                    좋은 도구는 “매번 손이 가는 반복 업무”에서 출발합니다.
                    같은 안내를 반복해서 답하고 있다면 FAQ 도구를, 명단을 매번
                    정리한다면 입력·집계 도구를 떠올려 보세요.
                  </p>
                  <div className="example-box">
                    <strong>행정 도구 아이디어 예시</strong><br />
                    - 학사 FAQ 안내 — 자주 묻는 질문을 검색·확인<br />
                    - 행사/프로그램 신청 양식 — 입력 → 목록 저장<br />
                    - 학사 일정 안내 — 월별 일정 한눈에 보기<br />
                    - 서식 다운로드 모음 — 부서별 양식 정리 페이지
                  </div>

                  <h4>2. 요구사항 정의 — 누가, 무엇을, 어떻게</h4>
                  <div className="prompt-example">{`너는 웹 서비스 기획 전문가야.
대학 행정 직원이 쓸 간단한 웹 도구의 요구사항 정의서를 작성해줘.
...
[출력]
1. 개요  2. 기능 목록(필수/선택)  3. 화면 목록  4. 데이터 항목`}</div>

                  <h4>3. 화면 설계</h4>
                  <ul>
                    <li><strong>입력 화면</strong>: 신청/등록 폼 (필요한 항목만 간단히)</li>
                    <li><strong>목록 화면</strong>: 들어온 내용을 표로 확인</li>
                    <li><strong>검색/필터</strong>: 많아지면 찾기 쉽게</li>
                  </ul>
              ...
              <div id="part2" className="lecture-section">
                ...
                <div className="lecture-content">
                  ...
                  <div className="example-box">
                    ...
                    <strong>React</strong>: 버튼 클릭·입력 같은 “동작”을 다루는 도구<br /><br />
                    세부 문법은 외울 필요 없습니다. <strong>무엇을 만들지</strong>만 명확히
...
- 상단: 행사명과 마감일 안내
- 입력 폼: 이름, 학번, 연락처, 참가 인원
- '신청' 버튼을 누르면 아래 목록 표에 추가
- 목록은 표로 보여주고, 각 행에 삭제 버튼
- 깔끔한 카드형 디자인, 남색 포인트 컬러
...
한 번에 다 만들지 말고, 먼저 입력 폼과 목록부터 보여줘."`}</div>
              ...
              <div id="part3" className="lecture-section">
                ...
                <div className="lecture-content">
                  <h4>1. 데이터를 어디에 둘까?</h4>
                  <div className="example-box">
                    <strong>브라우저 저장(localStorage)</strong>: 설치 없이 같은 PC에 저장 — 연습·개인용<br />
                    <strong>Google 스프레드시트</strong>: 익숙한 표에 데이터 모으기 — 공유·협업<br />
                    <strong>간단한 데이터베이스</strong>: 여러 사람이 함께 쓰는 본격 도구용
                  </div>

                  <h4>2. 입력한 내용 저장하고 불러오기</h4>
                  <div className="prompt-example">{`"신청 목록을 브라우저에 저장해서, 페이지를 새로고침해도
내용이 사라지지 않게 해줘. (localStorage 사용)
페이지를 다시 열면 저장된 목록이 그대로 보이게 해줘."`}</div>

                  <h4>3. 반복 업무 자동화</h4>
                  <div className="prompt-example">{`"신청 목록에서 학과별 인원수를 자동으로 집계해
표 아래에 '학과별 신청 현황'으로 보여줘.

그리고 'CSV로 내려받기' 버튼을 추가해서,
엑셀에서 열 수 있는 파일로 저장되게 해줘."`}</div>

                  <h4>4. 간단한 FAQ 검색/챗봇 붙이기</h4>
                  <div className="prompt-example">{`"자주 묻는 질문 목록(질문/답변)을 미리 넣어두고,
사용자가 검색어를 입력하면 관련 질문을 찾아 보여주는
검색창을 페이지 상단에 추가해줘."`}</div>
              ...
              <div id="part4" className="lecture-section">
                ...
                <div className="lecture-content">
                  ...
                  <div className="prompt-example">{`"내가 만든 이 웹페이지를 GitHub Pages로 배포하고 싶어.
GitHub 저장소 만들기부터 파일 올리기, Pages 설정까지
초보자도 따라할 수 있게 단계별로 알려줘."`}</div>
                  <div className="example-box">
                    <strong>배포 큰 흐름</strong><br />
                    ① GitHub에 저장소(Repository) 생성<br />
                    ② 만든 파일 업로드(또는 Claude Code로 push)<br />
                    ③ Settings → Pages에서 게시 설정<br />
                    ④ 발급된 주소(링크)를 동료에게 공유
                  </div>
                  ...
                  <div className="tip-box">
                    ...
                    기관의 정보보호 지침을 반드시 확인하세요.
                  </div>
                  <ul>
                    <li>작게 시작해 자주 개선 — 완벽보다 ‘동작하는 도구’ 먼저</li>
                    <li>반복 업무부터 적용해 시간 절감 효과를 체감</li>
                  ...
                  <ul>
                    ...
                    <li>저장 기능 + 자동 집계(또는 CSV 내려받기) 추가</li>
                    <li>GitHub Pages 배포 및 링크 공유</li>
                    <li>최종 발표 — 만든 도구 시연 &amp; 피드백</li>
                  </ul>

                  <div className="tip-box">
                    <strong>수료 후</strong>: 강의안·프롬프트 학습·추천 사이트는 교육 이후에도
                    계속 열람할 수 있습니다. 오늘 만든 도구를 실제 업무에 적용해 보세요.
                  </div>
                </div>
              </div>
