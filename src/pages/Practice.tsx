...
const SCENARIOS: Scenario[] = [
  ...
  },
  {
    id: 3,
    category: 'Streamlit',
    title: 'Streamlit 신청 현황 대시보드 생성',
    situation: '교환학생 프로그램 지원자 명단 CSV를 업로드하여 학과별 지원 현황, 희망 파견 국가별 분포, 핵심 통계를 시각화하는 Streamlit 대시보드를 만들어야 합니다.',
    goal: 'Streamlit 대시보드를 만드는 프롬프트를 작성하세요.',
    keywords: ['Streamlit', '대시보드', '데이터', 'CSV', '시각화', '차트', '지원자', 'pandas'],
  ...
  },
  {
    ...
    situation: '교직원 업무 효율화를 위한 학사 안내 AI 챗봇 웹앱을 기획하고 있습니다. 학생과 교직원이 학칙, 수강신청 FAQ, 졸업요건을 질문하면 Claude가 답변하는 서비스입니다.',
  ...
  },
  {
    ...
    situation: 'Streamlit 앱에 Claude API를 연동하여 유학생 생활·비자 관련 질의응답을 처리하는 AI 챗봇을 만들어야 합니다. 대화 이력을 유지하고, 국제교류처 행정 안내 전문가 역할을 수행해야 합니다.',
    goal: 'Claude API를 연동한 Streamlit 챗봇 코드를 요청하는 프롬프트를 작성하세요.',
    keywords: ['Claude', 'API', 'Streamlit', '챗봇', 'AI', '대화', '연동', '유학생'],
...
const Practice = (): ReactElement => {
  ...
  return (
    <>
      <SEOHead title="바이브코딩 실습 | HUFS Vibe Coding" description="대학 행정 실무를 위한 Claude 프롬프트 작성 실습 및 자동 채점" />
