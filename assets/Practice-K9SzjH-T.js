import{r as v,j as e}from"./index-tPfTz0Iu.js";import{S as W}from"./SEOHead-DKQgxNxX.js";const A=[{id:1,category:"React UI",title:"React 컴포넌트 생성 요청",situation:"교내 특강 신청자 관리 페이지를 만들어야 합니다. 상단에 신청자 입력 폼, 하단에 신청자 목록이 표시되고, 각 항목에 참석 체크박스와 삭제 버튼이 있어야 합니다.",goal:"AI에게 React 컴포넌트를 요청하는 프롬프트를 작성하세요.",keywords:["React","컴포넌트","신청자","명단","입력","목록","체크박스","삭제"],roleKeywords:["개발자","프론트엔드","전문가","역할","엔지니어"],formatKeywords:["코드","TypeScript","CSS","파일","형식","구조","컴포넌트"],exampleAnswer:`너는 React + TypeScript 프론트엔드 전문 개발자야.
